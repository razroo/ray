...
- Keep the cache bounded. Ray is designed to stay predictable under memory pressure, and doctor warns when `RAY_CACHE_MAX_BYTES` can grow past the small-VPS threshold for the generated gateway `MemoryMax`.

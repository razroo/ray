...
- The `/metrics` endpoint refreshes live queue saturation, cache, and cgroup resource gauges before responding, so a scraper can observe current pressure without a separate health probe.

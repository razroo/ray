...
- The `/metrics` endpoint refreshes live queue, cache, and async-job saturation plus cgroup resource gauges before responding, so a scraper can observe current pressure without a separate health probe.

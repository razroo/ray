...
Doctor uses the same value for strict `/var/log` journal/log headroom and for
the generated `WorkingDirectory` storage cushion, with a 512 MiB floor for the
synced checkout and Bun production install.

...
That runs lint, Prettier `--check`, tests (`bun run test` builds, runs the compiled Tap suite, then runs script tests with Bun), public deploy bundle smoke rendering, and Bun pack smoke checks for the public packages.

...
to print the exact install, ownership, optional checksum, and service-user
read/execute test commands for the resolved `llama-server` and
`RAY_MODEL_PATH`.

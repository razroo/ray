...
- deploy preflight checks and generated systemd memory/swap ceilings for systemd host readiness, memory fit, service-user access, Bun runtime compatibility, model files, async queue storage, and swap cushion
